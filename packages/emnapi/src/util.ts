...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
declare let napi_clear_last_error: (env: napi_env) => napi_status
// eslint-disable-next-line @typescript-eslint/no-unused-vars
declare let napi_set_last_error: (env: napi_env, error_code: napi_status, engine_error_code: uint32_t, engine_reserved: void_p) => napi_status
